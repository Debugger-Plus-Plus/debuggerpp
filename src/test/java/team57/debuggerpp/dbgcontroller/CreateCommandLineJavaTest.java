...
import team57.debuggerpp.dbgcontroller.steps.JavaSteps;
...
import static team57.debuggerpp.pages.ActionMenuFixtureKt.actionMenu;
import static team57.debuggerpp.pages.ActionMenuFixtureKt.actionMenuItem;

@ExtendWith(RemoteRobotExtension.class)
public class CreateCommandLineJavaTest {

    private final RemoteRobot remoteRobot = new RemoteRobot("http://127.0.0.1:8082");
    private final JavaSteps sharedSteps = new JavaSteps(remoteRobot);
